 ...
 */
!function(e){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=e();else if("function"==typeof define&&define.amd)define([],e);else{var a;"undefined"!=typeof window?a=window:"undefined"!=typeof global?a=global:"undefined"!=typeof self&&(a=self),a.hsimp=e()}}(function(){return function e(a,r,o){function n(s,t){if(!r[s]){if(!a[s]){var l="function"==typeof require&&require;if(!t&&l)return l(s,!0);if(i)return i(s,!0);var c=new Error("Cannot find module '"+s+"'");throw c.code="MODULE_NOT_FOUND",c}var d=r[s]={exports:{}};a[s][0].call(d.exports,function(e){var r=a[s][1][e];return n(r||e)},d,d.exports,e,a,r,o)}return r[s].exports}for(var i="function"==typeof require&&require,s=0;s<o.length;s++)n(o[s]);return n}({1:[function(e,a,r){a.exports={"ASCII Lowercase":["[a-z]",26],"ASCII Uppercase":["[A-Z]",26],"ASCII Numbers":["\\d",10],"ASCII Top Row Symbols":["[-!@£#$%^&*()=+_]",15],"ASCII Other Symbols":["[\\s\\?\\/\\.>,<`~\\|;:\\]}\\[{'\"\\\\]",19],"Unicode Latin 1 Supplement":["[\\u00A1-\\u00A2\\u00A4-\\u00FF]",93],"Unicode Latin Extended A":["[\\u0100-\\u017F]",128],"Unicode Latin Extended B":["[\\u0180-\\u024F]",208],"Unicode Latin Extended C":["[\\u2C60-\\u2C7F]",32],"Unicode Latin Extended D":["[\\uA720-\\uA7FF]",29],"Unicode Cyrillic Uppercase":["[\\u0410-\\u042F]",32],"Unicode Cyrillic Lowercase":["[\\u0430-\\u044F]",32]}},{}],2:[function(e,a,r){"use strict";var o=e("hsimp-library"),n={},i=o.prop(0),s=o.prop(1),t=function(e){var a={},r=0,t=[];if(!o.isString(e))throw Error("CharacterSet: Invalid type");return o.forEach(function(a,o){e.match(i(a))&&(t.push(o),r+=s(a))},n),a.getSets=function(){return t},a.getPossibleCharacters=function(){return r},a};t.setCharacterSets=function(e){n=e},a.exports=t},{"hsimp-library":10}],3:[function(e,a,r){a.exports={common:{name:"Mot de passe commun : Dans le top {{ value }} des mots de passe les plus utilisés.",message:"Votre mot de passe est très couramment utilisé. Il serait cracké presque instantanément."},xkcd:{name:"xkcd",message:"Je soupçonne que les craqueurs de mots de passe sont peut-être déjà sur celui-ci..."},jeff:{name:"Il y a toujours une porte de dérobée...",message:'"Le gars qui a fait le logiciel s\'appelait Jeff Jeffty Jeffty Jeff. Né le premier de Jeff, dix-neuf-jeffty-jeffty-jeff."'},lengthVeryShort:{name:"Longueur : Très court",message:"Votre mot de passe est très court. Plus un mot de passe est long, plus il est sûr."},possiblyWord:{name:"Peut-être un mot",message:"Votre mot de passe ressemble à un mot du dictionnaire ou à un nom. Si c'est un nom ayant une signification personnelle, il pourrait être facile à deviner. Si c'est un mot du dictionnaire, il pourrait être craqué très rapidement."},onlyNumbers:{name:"Variété de caractères : Juste des nombres",message:"Votre mot de passe ne contient que des nombres. Cela réduit de façon dramatique le nombre de combinaisons possibles."},wordAndNumber:{name:"Peut-être un mot et un nombre",message:"Votre mot de passe a l'air d'être juste un mot et quelques chiffres. Il s'agit d'un modèle très courant qui serait craqué très rapidement."},lengthShort:{name:"Longueur : Court",message:"Votre mot de passe est assez court. Plus un mot de passe est long, plus il est sûr."},justLetters:{name:"Variété de caractères : Juste des lettres",message:"Votre mot de passe ne contient que des lettres. L'ajout de chiffres et de symboles peut rendre votre mot de passe plus sûr."},noSymbols:{name:"Variété de caractères : Pas de symboles",message:"Votre mot de passe ne contient que des chiffres et des lettres. L'ajout d'un symbole peut rendre votre mot de passe plus sûr. N'oubliez pas que vous pouvez souvent utiliser des espaces dans les mots de passe."},telephone:{name:"Peut-être un numéro de téléphone / Date",message:"Votre mot de passe ressemble à un numéro de téléphone ou à une date. Si c'est le cas et qu'il a une signification personnelle, il peut être très facile pour quelqu'un de le deviner."},repeatedPattern:{name:"Motif répété",message:"Les caractères ou motifs répétés peuvent rendre votre mot de passe plus prévisible."},nonStandardCharacters:{name:"Variété de caractères : Caractères non standard",message:"Votre mot de passe contient un caractère absent du clavier. Cela devrait le rendre plus sûr."},lengthLong:{name:"Longueur : Long",message:"Votre mot de passe comporte plus de seize caractères."}}},{}],4:[function(e,a,r){"utiliser des";var o,n=e("hsimp-library"),i=[],s=function(e){return n.filter(function(e){return e},n.map(function(a){return a(e)},n.reduce(function(e,a){return e.concat(a.get())},[],i)))},t=function(e){if(o.hasOwnProperty(e.id)){var a=o[e.id];return{level:e.level,name:e.value?a.name.replace("{{ value }}",e.value):a.name,message:e.value?a.message.replace("{{ value }}",e.value):a.message}}throw new Error("checker: Missing dictionary entry "+e.id)},l=function(e){if(!o)throw new Error("checker: dictionary not set");var a,r={},i=["highlight","insecure","warning","achievement","notice"];if(!n.isString(e))throw Error("checker: Invalid type");return a=n.map(t,s(e)).sort(function(e,a){var r=function(e){var a=i.indexOf(e.level);return-1===a?i.length:a};return r(e)-r(a)}),r.isInsecure=function(){return n.some(function(e){return"insecure"===e.level},a)},r.hasWarnings=function(){return n.some(function(e){return"warning"===e.level},a)},r.hasAchievements=function(){return n.some(function(e){return"achievement"===e.level},a)},r.getChecks=function(){return a},r};l.setDictionary=function(e){o=e},l.setChecks=function(e){var a=new Error("setChecks takes an array of check objects");if(!n.isArray(e))throw a;e.forEach(function(e){if(!n.isFunction(e.get))throw a}),i=e},a.exports=l},{"hsimp-library":10}],5:[function(e,a,r){"use strict";var o=e("hsimp-library"),n=function(e){if(!o.isFunction(e))throw new Error("Check is not a function");var a={},r=[];return a.setDictionary=function(e){r=e},a.get=function(){return e(r)},a};a.exports=n},{"hsimp-library":10}],6:[function(e,a,r){"use strict";var o=e("hsimp-library"),n=e("../check");a.exports=n(function(e){return[function(a){var r;return a=a.toLowerCase(),o.forEach(function(e,o){if(e===a)return r=5*Math.ceil((o+1)/5),!1},e),!!r&&{level:"insecure",id:"common",value:r}}]})},{"../check":5,"hsimp-library":10}],7:[function(e,a,r){"use strict";var o=e("hsimp-library"),n=e("../check");a.exports=n(function(e){return o.map(function(e,a){var r=new RegExp(a);return function(a){return!!r.test(a)&&e}},e)})},{"../check":5,"hsimp-library":10}],8:[function(e,a,r){a.exports={"^correcthorsebatterystaple$":{level:"insecure",id:"xkcd"},"^jeff|geoff$":{level:"easteregg",id:"jeff"},"^.{1,6}$":{level:"warning",id:"lengthVeryShort"},"^[a-zA-Z]{1,16}$":{level:"warning",id:"possiblyWord"},"^[0-9]+$":{level:"warning",id:"onlyNumbers"},"^([a-zA-Z]+[0-9]+|[0-9]+[a-zA-Z]+)$":{level:"warning",id:"wordAndNumber"},"^.{7,9}$":{level:"warning",id:"lengthShort"},"^[A-Za-z]+$":{level:"notice",id:"justLetters"},"^(?:\\d+[a-zA-Z]|[a-zA-Z]+\\d)[a-zA-Z\\d]*$":{level:"notice",id:"noSymbols"},"^[\\-\\(\\)\\.\\/\\s0-9]+$":{level:"warning",id:"telephone"},"(.+)\\1{2,}":{level:"warning",id:"repeatedPattern"},"[^A-Za-z0-9\\u0000-\\u007E]":{level:"achievement",id:"nonStandardCharacters"},"^.{17,}$":{level:"achievement",id:"lengthLong"}}},{}],9:[function(e,a,r){
